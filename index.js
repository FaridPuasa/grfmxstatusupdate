    ...
    for (const consignmentID of uniqueConsignmentIDsArray) {
        try {
            ...
            if (product != 'FMX') {
                ...
                if ((req.body.statusCode == 12) && (data.data.status == 'info_recv') && (product == 'KPTDP')) {
                    address = data.data.address.toUpperCase();
                ...
                if ((req.body.statusCode == 12) && (data.data.status == 'info_recv') && (product == 'PDU')) {
                    address = data.data.address.toUpperCase();
                ...
                if ((req.body.statusCode == 12) && (product != 'GRP') && (product != 'CBSL') && (product != 'TEMU') && (product != 'PDU') && (product != 'KPTDP')) {
                    if ((data.data.status == 'info_recv')) {
                        if (existingOrder === null) {
                            if ((product == 'EWE') || (product == 'EWENS')) {
                                address = data.data.address.toUpperCase();
